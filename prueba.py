...
#         """
#         Grafica las combinaciones filtradas en un solo gráfico.
#         """
...
#         plt.title("Comparación de Respuestas del Sistema con Diferentes Parámetros PID")
#         plt.xlabel("Tiempo (s)")
...
#         """
#         Agrega una curva al gráfico con la respuesta del sistema para una combinación de parámetros PID.
#         """
#         label = f"KP={KP}, KI={KI}, KD={KD}"
#         plt.plot(time, yout, label=label)
